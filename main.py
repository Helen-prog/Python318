...
#
# def uniq(a, b):
#     return " ".join([str(i) for i in list(set(l1).symmetric_difference(l2))])[::-1]
#
#
# print(uniq(l1, l2))


# n = int(input("Введите кол-во долларов: "))
#
# print("Вы ввели:", end=" ")
# if 11 <= n <= 14 or n % 20 == 11 or n % 200 == 11 or n % 20 == 12 or n % 200 == 12 or n % 20 == 13 or n % 200 == 13 \
#         or n % 20 == 14 or n % 200 == 14:
#     if n // 100 % 10 == 2:
#         print("двести", end=" ")
#     if n // 100 % 10 == 3:
#         print("триста", end=" ")
...
#         print("тысяча", end=" ")
#
#     if n == 11 or n % 20 == 11 or n % 200 == 11:
#         print("одиннадцать", end=" ")
#     if n == 12 or n % 20 == 12 or n % 200 == 12:
#         print("двенадцать", end=" ")
#     if n == 13 or n % 20 == 13 or n % 200 == 13:
#         print("тринадцать", end=" ")
#     if n == 14 or n % 20 == 14 or n % 200 == 14:
...
for _ in range(9):
    ...
    pos = int(input(f"hod {player} (0-9):"))
    if board[pos] == " ":
        board[pos] = player

        if any(all(board[i] == player for i in line) for line in [(0,1,2), (3,4,5),(0,3,6),(6,7,8),(1,4,7),(2,4,8),
                                                                  (2,4,6)]):
